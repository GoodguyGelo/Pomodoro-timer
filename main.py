...
def count_down(count):
    ...
    canvas.itemconfigure(timer_text, text=f"{count_minute}:{count_seconds}")
    if count > 0:
        global timer
...
title = Label(text="Timer", font=(FONT_NAME, 50, "bold"), fg=GREEN, highlightthickness=0, bg=YELLOW)
